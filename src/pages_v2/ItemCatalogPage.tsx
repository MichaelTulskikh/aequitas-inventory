...
import "../styles_new/item-catalog.css";
...
export default function ItemCatalogPage() {
  ...
  return (
    <div className="item-catalog-page">
      <div className="item-catalog-header">
        <div>
          <h1 className="item-catalog-title">Item Catalog</h1>
          <p className="item-catalog-subtitle">
          ...
          <form className="item-form" onSubmit={handleSave}>
            ...
            <div className="attribute-editor">
              ...
              {form.attribute_definitions.length === 0 ? (
                ...
                <div className="attribute-editor-stack">
                  {form.attribute_definitions.map((attr, index) => (
                    <div key={index} className="attribute-editor-card">
                      <div className="my-profile-grid">
                        <div className="form-group">
