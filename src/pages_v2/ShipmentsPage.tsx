...
import "../styles_new/shipments.css"
    ...
    <div className="shipments-page">
      ...
      <div className="shipment-summary-grid">
        <div className="shipment-summary-card">
          <div className="shipment-summary-label">Draft</div>
          <div className="shipment-summary-value">{summary.draft}</div>
        </div>
        <div className="shipment-summary-card">
          <div className="shipment-summary-label">Submitted</div>
          <div className="shipment-summary-value">{summary.submitted}</div>
        </div>
        <div className="shipment-summary-card">
          <div className="shipment-summary-label">Approved</div>
          <div className="shipment-summary-value">{summary.approved}</div>
        </div>
        <div className="shipment-summary-card">
          <div className="shipment-summary-label">Fulfilled</div>
          <div className="shipment-summary-value">{summary.fulfilled}</div>
        </div>
      </div>
          ...
          <tbody>
            {shipments.map((shipment) => {
              ...
              return (
                <tr key={shipment.id}>
                  <td>
                    <div className="shipment-number-cell">
                      <div className="shipment-number">
                        {shipment.shipment_number}
                      </div>
                      {shipment.notes && (
                        <div className="shipment-notes-preview">
                          {shipment.notes}
                        </div>
                      )}
                    </div>
                  ...
                  <td>
                    <div className="shipment-requester-cell">
                  ...
                  <td>
                    <div className="shipment-created-by-cell">
