...
import "../styles_new/inventory-valuation.css";
  ...
  useEffect(() => {
    ...
    async function loadFxRates() {
      try {
        ...
        const res = await fetch("https://api.frankfurter.dev/v2/rates?base=UAH&quotes=USD,EUR,GBP");
        if (!res.ok) {
...
//     const total = lots.length < pageSize ? page : page + 1;
//     return Math.max(1, total);
//   }, [lots.length, page, pageSize]);
  ...
  return (
    <div className="inventory-valuation-page">
      <div className="inventory-valuation-header">
        <div>
          <h1 className="inventory-valuation-title">Inventory Valuation</h1>
          <p className="inventory-valuation-subtitle">
            Track and update UAH value for inventory lots. Default view shows
            lots that still need valuation.
          </p>
        </div>
      </div>

      {error && <div className="dashboard-error">Error: {error}</div>}
      <div className="inventory-valuation-filters">
      ...
      {summary && (
        <div className="inventory-valuation-summary-grid">
              ...
              {lots.map((lot) => {
                ...
                return (
                  <tr key={lot.inventory_lot_id}>
                    <td>
                      <div className="valuation-item-cell">
                        <div className="valuation-item-name">
                          {lot.item_name}
                        </div>
                        <div className="valuation-item-sub">
