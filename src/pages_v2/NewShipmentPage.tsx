    ...
    try {
      ...
      if (itemId && qty && qty > 0) {
        await createShipmentLine(shipmentId, {
          ...
          notes: prefillLotId ? `Created from inventory selection (${prefillLotId})` : undefined,
        });
      }
      ...
      <div className="new-shipment-grid">
        <section className="shipment-panel">
          ...
          {!profile ? (
            ...
            <>
              <div className={`profile-completeness ${complete ? "complete" : "incomplete"}`}>
        ...
        <section className="shipment-panel">
          ...
          <form className="shipment-line-form" onSubmit={handleCreateShipment}>
