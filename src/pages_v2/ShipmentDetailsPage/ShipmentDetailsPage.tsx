...
function AllocationPanel({
  ...
  return (
    <div className={styles.allocationPanel}>
      ...
      <div className={styles.allocationExisting}>
      ...
      <div className={styles.allocationNew}>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className={styles.lotPreview}>
              {lots.map((lot) => (
                <div key={lot.inventory_lot_id} className={styles.lotCard}>
    ...
    <div className={`page__wrapper ${styles.page}`}>
      <div className={styles.header}>
        <div>
          ...
          <h1 className={styles.title}>{shipment.shipment_number}</h1>
