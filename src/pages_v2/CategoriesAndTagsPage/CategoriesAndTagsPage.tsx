...
import styles from "./CategoriesAndTagsPage.module.css";
...
export default function CategoriesAndTagsPage() {
  ...
  function renderCategoryNode(node: CategoryTreeNode): React.ReactNode {
    ...
    const parentName = node.parent_category_id
          ...
          <div className={styles.treeMain}>
            <div className={styles.treeTitleRow}>
              ...
              <span
                className={cx(
                  styles.statusChip,
                  node.is_active ? styles.statusActive : styles.statusInactive,
                )}
              >
    ...
    <div className={`page-shell ${styles.page}`}>
      ...
      <div className={styles.grid}>
        ...
        <section className="panel">
          ...
          {showTagForm && (
            <form className={styles.form} onSubmit={handleSaveTag}>
              <div className="form-grid">
                <div className="form-group">
                  <label className={styles.label}>Name</label>
                  <input
